...
from app.services.calculation.metrics.pump_efficiency.pipeline import PumpEfficiencyPipeline
...
__all__ = ['PumpEfficiencyPipeline', 'calculate_pump_efficiency']
...
def calculate_pump_efficiency(task: Task) -> TaskResult:
    """
    pump_efficiency 计算函数（适配 Scheduler 接口）
    ...
    if _pipeline_instance is None:
        _pipeline_instance = PumpEfficiencyPipeline()
