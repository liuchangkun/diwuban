...
class MethodSelector:
    ...
    METHODS = [
        ...
        },
        {
            ...
            'conditions': {'has_calc_params': ['rho', 'g']}
        }
    ]
    ...
    def select_method(self, data: pd.DataFrame) -> str:
        ...
        raise ValueError("无可用的计算方法：缺少必需的数据列或参数")
    ...
    def _check_conditions(self, data: pd.DataFrame, conditions: Dict[str, Any]) -> bool:
        ...
        """
        # 检查参数依赖
        if 'has_calc_params' in conditions:
            required_params = conditions['has_calc_params']
