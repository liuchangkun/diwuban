...
__all__ = ['PumpShaftPowerPipeline', 'calculate_pump_shaft_power']
...
def calculate_pump_shaft_power(task: Task) -> TaskResult:
    """
    pump_shaft_power 计算函数（适配 Scheduler 接口）
    ...
    if _pipeline_instance is None:
        _pipeline_instance = PumpShaftPowerPipeline()
