            ...
            with conn.cursor() as cur:
                ...
                if test_results:
                    ...
                    for i, row in enumerate(test_results[:5]):
                        timestamp, device_id, device_name, flow_rate, pressure, power, frequency = row
                        print(f"  {i+1}. 时间: {timestamp}, 设备: {device_id}, 流量: {flow_rate}, 压力: {pressure}, 功率: {power}, 频率: {frequency}")
