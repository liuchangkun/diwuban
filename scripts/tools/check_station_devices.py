        ...
        with psycopg.connect(dsn) as conn:
            with conn.cursor() as cur:
                ...
                for device in devices:
                    ...
                    print(
                        f"  设备{device_id:2}: {device_name:20} | {type_info:15} | {metric_count:3}个指标 | {data_count:,}条数据"
                    )
                ...
                for row in station_metrics:
                    ...
                    print(
                        f"  {prefix:15}: {metric_count:3}个指标, {total_data:,}条数据"
                    )
                ...
                for row in station_stats:
                    ...
                    print(
                        f"    设备: {device_count}个 (水泵:{pump_count}, 总管:{pipeline_count})"
                    )
                    print(
                        f"    指标: {total_metrics}个 (pump:{pump_metrics}, main_pipeline:{pipeline_metrics})"
                    )
