...
1. 清理device_id=1-3的扩展数据（source_hint='e2e_test_data'）
2. 重新扩展到30天
"""
    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            for device_id in [1, 2, 3]:
                # 删除扩展数据（source_hint='e2e_test_data'）
                cur.execute("""
                ...
                print(f"✅ device_id={device_id}: 删除 {deleted_count:,} 条扩展数据")
